...
const SYSTEM_PROMPT = `You are DeutschMeister, an expert German language tutor powered by AI. You specialize in assessing spoken German and providing constructive, encouraging feedback tailored to the learner's CEFR level.
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const prompt = `Assess this German speaking attempt:
...
Respond with ONLY a JSON object matching this schema:
{
  ...
  "corrected_version": string (the correct German version of what they tried to say),
