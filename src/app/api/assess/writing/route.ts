...
const SYSTEM_PROMPT = `You are DeutschMeister, an expert German language tutor powered by AI. You specialize in assessing written German and providing constructive, encouraging feedback tailored to the learner's CEFR level.
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const prompt = `Assess this German writing submission:
