...
function GermanFlagIcon() {
  return (
    <svg width="24" height="16" viewBox="0 0 24 16" className="shrink-0 rounded-[2px] overflow-hidden">
      <rect y="0" width="24" height="5.33" fill="#000" />
      <rect y="5.33" width="24" height="5.33" fill="#DD0000" />
      <rect y="10.66" width="24" height="5.34" fill="#FFCC00" />
    </svg>
  );
}
    ...
    >
      {correct ? (
        <>
          ...
          <div>
            <span className="text-[#4CAF50] font-semibold">Richtig!</span>
        ...
        <>
          ...
          <div>
            <span className="text-[#EF4444] font-semibold">Leider falsch.</span>
            {correctAnswer && (
        ...
        <div className="flex items-center gap-2 mb-2">
          {content.source_language === 'en' ? (
            ...
            <div className="flex items-center gap-2">
              <GermanFlagIcon />
              <span className="text-xs uppercase tracking-widest text-[#3d6b6b]/70 font-semibold">Deutsch</span>
            </div>
          )}
        </div>
