...
const FOOTBALL_A1_PRACTICE: Exercise[] = [
  ...
  },
  {
    ...
    content: {
      words: ['spielt', 'Er', 'Fußball', 'gern'],
      correct_order: 'Er spielt gern Fußball',
  ...
  },
  {
    ...
    type: 'translation',
    level: 'A1',
    instruction: 'Translate this sentence into German.',
    content: {
      source: 'The team plays well.',
      source_language: 'en',
      correct_translation: 'Die Mannschaft spielt gut',
  ...
  },
  {
    ...
    content: {
      sentence: 'Die Spieler ___ auf dem Feld.',
      options: ['laufen', 'lauft', 'läufst', 'laufe'],
      correct_answer: 'laufen',
    } as FillBlankContent,
  },
  {
    id: 'fb-trans-2',
    ...
    content: {
      source: 'Der Torwart hält den Ball.',
      source_language: 'de',
      correct_translation: 'The goalkeeper holds the ball',
    } as TranslationContent,
  },
];
...
const GENERAL_A1_PRACTICE: Exercise[] = [
  {
    ...
    instruction: 'Fill in the blank with the correct article.',
    content: {
      sentence: '___ Frau trinkt Kaffee.',
      options: ['Der', 'Die', 'Das', 'Ein'],
      correct_answer: 'Die',
    } as FillBlankContent,
  },
  ...
  },
  {
    ...
    content: {
      ...
      source_language: 'en',
      correct_translation: 'Ich lerne Deutsch',
    } as TranslationContent,
  },
  {
    id: 'gen-fill-2',
    ...
    content: {
      sentence: '___ kommen aus Deutschland.',
  ...
  },
  {
    ...
    content: {
      words: ['ist', 'Das', 'Buch', 'gut'],
      correct_order: 'Das Buch ist gut',
    } as SentenceBuildContent,
  },
];

// Input phase content
const INPUT_CONTENT: Record<string, { title: string; explanation: string; examples: { german: string; english: string }[] }> = {
  football: {
    title: 'Definite Articles: der, die, das',
    explanation:
      'In German, every noun has a grammatical gender. The definite articles are: der (masculine), die (feminine), das (neuter). Football vocabulary: der Ball (the ball), die Mannschaft (the team), das Tor (the goal), der Spieler (the player), das Feld (the field), die Halbzeit (half-time).',
    examples: [
      { german: 'Der Ball ist rund.', english: 'The ball is round.' },
      { german: 'Die Mannschaft spielt gut.', english: 'The team plays well.' },
      { german: 'Das Tor ist groß.', english: 'The goal is big.' },
    ],
  },
  general: {
    title: 'Present Tense: Regular Verbs',
    explanation:
      'German regular verbs follow a simple conjugation pattern in the present tense. Remove the -en ending and add: ich -e, du -st, er/sie/es -t, wir -en, ihr -t, sie/Sie -en. For example: lernen (to learn) becomes ich lerne, du lernst, er lernt.',
    examples: [
      { german: 'Ich lerne Deutsch.', english: 'I learn German.' },
      { german: 'Du spielst gut.', english: 'You play well.' },
      { german: 'Wir kommen aus Berlin.', english: 'We come from Berlin.' },
    ],
  },
};
...
const PRODUCTION_PROMPTS: Record<string, { writing: WritingContent; speaking: SpeakingContent }> = {
  football: {
    writing: {
      prompt: 'Write 2-3 sentences about your favorite football team. Use at least one definite article (der/die/das).',
      min_sentences: 2,
      vocabulary_to_use: ['Mannschaft', 'spielen', 'Tor'],
      grammar_focus: 'Definite articles',
    },
    speaking: {
      target_phrase: 'Meine Mannschaft spielt sehr gut Fußball.',
      context: 'Tell someone about your favorite football team.',
    },
  },
  general: {
    writing: {
      prompt: 'Introduce yourself in German. Write 2-3 sentences using the present tense.',
      min_sentences: 2,
      vocabulary_to_use: ['heißen', 'kommen', 'lernen'],
      grammar_focus: 'Present tense conjugation',
    },
    speaking: {
      target_phrase: 'Ich heiße ... und ich lerne Deutsch.',
      ...
      case 'input':
        return (
          ...
          >
              ...
              {inputContent.examples.map((ex, idx) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <AudioButton text={ex.german} level={profile.assessed_level} />
                  </div>
            ...
            <Button onClick={() => {
              setWordsLearned(inputContent.examples.map((e) => e.german));
              advancePhase();
            }}>
