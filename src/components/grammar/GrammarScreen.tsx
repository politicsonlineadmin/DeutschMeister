...
function loadGrammarPoints(): GrammarPoint[] {
  ...
  try {
    const raw = localStorage.getItem('deutschmeister_grammar');
    if (!raw) return [];
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        >
          ...
          <p className="text-[#3d6b6b]/70 text-sm mt-1">
            Reference panel for German grammar topics by CEFR level
          </p>
        </motion.div>
                                ...
                                {data.domain_examples.map((example, j) => (
                                  ...
                                  >
                                    <div className="flex items-center gap-2">
                                      ...
                                      <button
                                        onClick={() => speak(example.german, profile.assessed_level)}
                                        disabled={isSpeaking}
